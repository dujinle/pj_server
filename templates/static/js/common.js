$(function(){
	...
	//表格隔行换色
//	$(".table_gray tr:even").css("background","url(../img/table_gray_tr_even_bg.gif) repeat-x");
//	$(".intable_gray tr:even").css("background","url(../img/table_gray_tr_even_bg.gif) repeat-x");
	//详细页tab切换
